...
class EntrySourceWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (entry is TextEntry) {
      ...
      return build_text_entry(textEntry, vocabulary as TextVocabulary, style ?? const TextStyle(fontSize: 16));
  ...
  build_text_entry(TextEntry textEntry, TextVocabulary vocabulary, TextStyle style) {
  ...
  build_error_entry(ImageEntry imageEntry, double imageWidth, double imageHeight) {
    return Container(
        width: imageWidth,
        height: imageHeight,
